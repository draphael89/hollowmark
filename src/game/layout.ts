...
export const S0_LAYOUT = {
  ...
  sidePanel: {
    ...
    selectedCard: {
      ...
      w: 204,
      h: 44,
      title: { x: SIDE_PANEL.x + 18, y: SIDE_PANEL.y + 33 },
      meta: { x: SIDE_PANEL.x + 18, y: SIDE_PANEL.y + 47 },
      rules: { x: SIDE_PANEL.x + 18, y: SIDE_PANEL.y + 60 },
    },
    heroStartY: SIDE_PANEL.y + 78,
    heroGapY: 48,
    ...
    heroStatus: { x: SIDE_PANEL.x + 16, yOffset: 30 },
    debtWarning: 4,
